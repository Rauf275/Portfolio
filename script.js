...
const translations = {
  ...
  en: {
    ...
    "about.text": "I'm an IT support specialist with practical experience in troubleshooting, hardware & software installation and configuration, and Help Desk work. I know CompTIA A+ Core 1 and Core 2 topics well — computer hardware, Windows, networking basics, and network switch configuration. When something breaks, I try to figure out what's actually causing it instead of just patching the symptom, and I make sure to explain to the user what happened and how I fixed it. I usually start by narrowing down where the problem is coming from — hardware, software, or connection — before jumping to a fix, and I check that everything works properly afterward, not just that the error message is gone. I've handled support tickets, worked with both hardware and software problems, and configured computers from scratch — installing the OS, setting up drivers and software, and getting everything ready for use. I have a working understanding of Group Policy and domain environments — I can configure basic policies, work with access permissions, and troubleshoot issues related to connecting computers to a domain and their operation within a domain environment. I'm responsible and work well in a team. On top of my IT support background, I also build websites using HTML, CSS, JavaScript, React, and Bootstrap. I want to keep learning and build a real career in IT.",
  ...
  az: {
    ...
    "about.text": "Mən troubleshooting, avadanlıq və proqram təminatının quraşdırılması və konfiqurasiyası, həmçinin Help Desk sahəsində praktiki təcrübəyə malik IT dəstək mütəxəssisiyəm. CompTIA A+ Core 1 və Core 2 mövzularını yaxşı bilirəm — kompüter avadanlığı, Windows, şəbəkələrin əsasları və şəbəkə switch-lərinin konfiqurasiyası. Nə vaxt ki, bir şey işləmir, mən problemin simptomunu sadəcə aradan qaldırmaq əvəzinə, əsl səbəbini müəyyən etməyə çalışıram və istifadəçiyə nə baş verdiyini və necə həll etdiyimi izah edirəm. Adətən əvvəlcə problemin haradan qaynaqlandığını müəyyənləşdirirəm — avadanlıq, proqram təminatı, yoxsa əlaqə problemi — sonra həllinə keçirəm, və bundan sonra sadəcə xəta mesajının yox olduğunu deyil, hər şeyin düzgün işlədiyini yoxlayıram. Mən ticketlərlə işləmişəm, həm avadanlıq, həm də proqram təminatı problemlərini həll etmişəm, kompüterləri sıfırdan konfiqurasiya etmişəm — ƏS-in quraşdırılması, driver və proqramların qurulması, sistemin istifadəyə tam hazır hala gətirilməsi. Həmçinin Group Policy və domen mühitləri barədə anlayışım var — əsas siyasətləri konfiqurasiya edə bilirəm, giriş icazələri ilə işləyirəm və kompüterlərin domenə qoşulması və domen mühitində işləməsi ilə bağlı problemləri həll edə bilirəm. Mən məsuliyyətliyəm və komanda ilə yaxşı işləyirəm. IT dəstək təcrübəmlə yanaşı, frontend developer kimi də təcrübəm var — HTML, CSS, JavaScript, React və Bootstrap istifadə edərək saytlar hazırlayıram. Öyrənməyə davam etmək və IT sahəsində real karyera qurmaq istəyirəm.",
